...
\renewcommand{\xRefIncrementOne}{6.0}
 ...
 \node[inner sep=0pt] (tmp) at (\xRefPosOne,\yRefPosOne)
    {\includegraphics[width=6.0cm]{/home/oviazlo/Desktop/beamerPresentations/FCCee/pictures/FCCee_different_fitting.png}};
 
 \node[inner sep=0pt] (tmp) at (\xRefPosOne + \xRefIncrementOne,\yRefPosOne)
    {\includegraphics[width=6.0cm]{/home/oviazlo/Desktop/beamerPresentations/FCCee/pictures/pt1_v2.png}};    
    
    
\node [Box] at (\xRefPosOne+3,\yRefPosOne-4) (box){%
  \begin{minipage}{1.0\textwidth}
    \begin{itemize}
      \item 1 GeV muons, no track reffiting
      \item d0 residuals (for 90$^{\circ}$ and 35$^{\circ}$): 
      \begin{itemize}
       \item 0.3$\%$ X$_0$ - 18 $\mu$m - 43 $\mu$m
       \item 0.6$\%$ X$_0$ - 22 $\mu$m - 52 $\mu$m
       \item 0.8$\%$ X$_0$ - 25 $\mu$m - 56 $\mu$m
      \end{itemize}
