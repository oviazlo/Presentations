...
\begin{tikzpicture}[overlay]
 ...
 \node  at (\xRefPosOne+1,\yRefPosOne+1.5) (box){%
...
%   };
 ...
 \node[inner sep=0pt] (tmp) at (\xRefPosOne+3.3,\yRefPosOne+1.2)
    {\includegraphics[width=6cm]{muonEff_bbbar_FCCee/muonEff_bbar_vs_cosTheta.pdf}};
...
\begin{tikzpicture}[overlay]
 ...
 \node[inner sep=0pt] (tmp) at (\xRefPosOne+3.3,\yRefPosOne+1.2)
    {\includegraphics[width=6cm]{muonEff_bbbar_FCCee/muonEff_bbar_vs_vertexZ.pdf}};
...
%*****************************************************************************
% %*****************************************************************************
% \begin{frame}{\large \large Muon efficiency with $b\bar{b}$ sample at 3 TeV with CLIC detector}
% 
% \renewcommand{\yRefPosOne}{-1.5}
% \renewcommand{\xRefPosOne}{5.3}
% \renewcommand{\xRefIncrementOne}{5.5}
...
% 
%  \node[inner sep=0pt] (tmp) at (\xRefPosOne-2.7,\yRefPosOne+1.2)
%     {\includegraphics[width=6cm]{muonEff_bbbar_CLIC/muonEff_bbar_vs_E.pdf}};
%     
%  \node[inner sep=0pt] (tmp) at (\xRefPosOne+3.3,\yRefPosOne+1.2)
%     {\includegraphics[width=6cm]{muonEff_bbbar_CLIC/muonEff_bbar_vs_cosTheta.pdf}};
%     
% % % HELPER draw advanced helping grid with axises:
% % \draw(-0.5,-4) to[grid with coordinates] (11.5,4);
% \end{tikzpicture}
...
% 
%  \node[inner sep=0pt] (tmp) at (\xRefPosOne-2.7,\yRefPosOne+1.2)
%     {\includegraphics[width=6cm]{muonEff_bbbar_CLIC/muonEff_bbar_vs_vertexR.pdf}};
%     
%  \node[inner sep=0pt] (tmp) at (\xRefPosOne+3.3,\yRefPosOne+1.2)
%     {\includegraphics[width=6cm]{muonEff_bbbar_CLIC/muonEff_bbar_vs_vertexZ.pdf}};
%     
% % % HELPER draw advanced helping grid with axises:
% % \draw(-0.5,-4) to[grid with coordinates] (11.5,4);
% \end{tikzpicture}
...
% %*****************************************************************************
%*****************************************************************************
\begin{frame}{\large \large Single muon gun, E=50 GeV, uniform cos(theta)}
\renewcommand{\yRefPosOne}{-0.9}
\renewcommand{\xRefPosOne}{4.2}
\renewcommand{\xRefIncrementOne}{7.5}
\begin{tikzpicture}[overlay]
 ...
 \node[inner sep=0pt] (tmp) at (\xRefPosOne+1.0,\yRefPosOne-0.1)
  {\includegraphics[width=8cm]{muonEff_temp_vertexR.pdf}};
