...
%     {\includegraphics[width=8cm]{OT_fix.png}};
...
\node [mybox] at (8,0) (box){%
    \begin{minipage}{5cm}
%        \scriptsize 
%         \begin{itemize}
%          \item New version of the detector model:
         \begin{itemize}
            \item scaled CLIC VTX barrel
            \item adjustment of half-length sizes of IT and OT barrels to remove tiny overlaps/holes
          \end{itemize}
%         \end{itemize}

    \end{minipage}
};
\node[fancytitle, right=15pt] at (box.north west) {FCCee$\_$o5$\_$v03};
