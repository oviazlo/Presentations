void calice_CLIC_vs_FCCee_effVsEnergy_pions()
{
//=========Macro generated from canvas: c1/A Simple Graph Example
//=========  (Wed Mar  7 11:28:10 2018) by ROOT version6.08/00
   ...
   Graph_Graph1002->SetMinimum(0.9020982);
   Graph_Graph1002->SetMaximum(0.9592431);
