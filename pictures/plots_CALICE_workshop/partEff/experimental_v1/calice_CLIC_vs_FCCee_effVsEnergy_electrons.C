void calice_CLIC_vs_FCCee_effVsEnergy_electrons()
{
//=========Macro generated from canvas: c1/A Simple Graph Example
//=========  (Wed Mar  7 13:20:37 2018) by ROOT version6.08/00
   TCanvas *c1 = new TCanvas("c1", "A Simple Graph Example",110,116,800,700);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   c1->SetHighLightColor(2);
   c1->Range(-25.0682,0.2540541,122.3918,1.064865);
   c1->SetFillColor(0);
   c1->SetBorderMode(0);
   c1->SetBorderSize(2);
   c1->SetTickx(1);
   ...
   Graph_Graph1001->SetMinimum(0.4);
   ...
   Graph_Graph1002->SetMinimum(0.7803416);
   Graph_Graph1002->SetMaximum(0.9976219);
