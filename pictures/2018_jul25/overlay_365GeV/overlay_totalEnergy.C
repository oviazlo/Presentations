...
//=========  (Tue Jul 24 16:40:34 2018) by ROOT version6.08/00
   ...
   Energy__2->SetBinContent(11,1);
   Energy__2->SetBinContent(12,4);
   Energy__2->SetBinContent(13,1);
   ...
   Energy__3->SetBinContent(20,2);
   Energy__3->SetBinContent(21,1);
   Energy__3->SetBinContent(23,2);
   Energy__3->SetBinContent(25,1);
   ...
   Energy__5->SetBinContent(10,1);
   Energy__5->SetBinContent(12,1);
   Energy__5->SetBinContent(13,2);
   Energy__5->SetBinContent(14,1);
   Energy__5->SetBinContent(16,1);
