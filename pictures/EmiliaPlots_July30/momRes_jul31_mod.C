...
//=========  (Wed Jul 26 15:45:19 2017) by ROOT version6.08/00
   ...
   gre->SetName("Graph0");
   gre->SetTitle("");
   gre->GetXaxis()->SetTitle("p [GeV/c]");
   gre->GetYaxis()->SetTitle("#sigma(#Delta p_{T}/p_{T,true}^{2}) [GeV^{-1}]");
   gre->SetFillColor(1);
   ...
   TH1F *Graph_Graph1001 = new TH1F("Graph_Graph1001","",100,0.9,549.9);
   ...
   Graph_Graph1001->GetYaxis()->SetTitle("#sigma(#Delta p_{T}/p_{T,true}^{2}) [GeV^{-1}]");
   Graph_Graph1001->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph1001->GetXaxis()->SetTitleOffset(0.85);
   Graph_Graph1001->GetXaxis()->SetTitle("p [GeV/c]");

   gre->SetHistogram(Graph_Graph1001);
   leg->AddEntry(gre,"#theta = 10#circ","p");
   ...
   TH1F *Graph_Graph1002 = new TH1F("Graph_Graph1002","",100,0.9,549.9);
   ...
   leg->AddEntry(gre,"#theta = 30#circ","p");
   ...
   TH1F *Graph_Graph1003 = new TH1F("Graph_Graph1003","",100,0.9,549.9);
   ...
   leg->AddEntry(gre,"#theta = 50#circ","p");
   ...
   TH1F *Graph_Graph1004 = new TH1F("Graph_Graph1004","",100,0.9,549.9);
   ...
   leg->AddEntry(gre,"#theta = 70#circ","p");
   ...
   TH1F *Graph_Graph1005 = new TH1F("Graph_Graph1005","",100,0.9,549.9);
   ...
   leg->AddEntry(gre,"#theta = 89#circ","p");
   ...
   TPaveText *pt = new TPaveText(0.7798567,0.0044958,0.9001433,0.065,"blNDC");
   // pt->SetName("title");
   pt->SetBorderSize(0);
   pt->SetFillColor(0);
   pt->SetFillStyle(0);
   ...
   // TText *AText = pt->AddText("p [GeV/c]");
   pt->Draw();
   c1->Modified();
   c1->cd();
   c1->SetSelected(c1);
