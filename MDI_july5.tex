...
%     {\includegraphics[width=5.0cm]{FCCee_noBeampipe.png}};
%  
...
\node [mybox] at (5.5,\yRefPosOne) (box){%
    \begin{minipage}{10cm}
%        \scriptsize 
        \begin{itemize}
         \item 200 GeV muons
	 \item no magnetic field
	 \item large value of Geant range-cut
	 \item reconstruction: only digitizers
        \end{itemize}

    \end{minipage}
};
\node[fancytitle, right=15pt] at (box.north west) {Dataset};
...
\renewcommand{\xRefIncrementOne}{6.0}
 ...
 \node[inner sep=0pt] (tmp) at (\xRefPosOne,\yRefPosOne)
    {\includegraphics[width=14cm]{VXD_barrel_1.png}};

 \node[inner sep=0pt] (tmp) at (\xRefPosOne,\yRefPosOne+2.5)
    {\mySmallCenterBox{Theta: 0..180}};
...
\renewcommand{\xRefIncrementOne}{6.0}
 ...
 \node[inner sep=0pt] (tmp) at (\xRefPosOne,\yRefPosOne)
    {\includegraphics[width=14cm]{VXD_endcaps_1.png}};
...
\renewcommand{\xRefIncrementOne}{6.0}
 ...
 \node[inner sep=0pt] (tmp) at (\xRefPosOne,\yRefPosOne)
    {\includegraphics[width=14cm]{IT_barrel_1.png}};
...
\renewcommand{\xRefIncrementOne}{6.0}
 ...
 \node[inner sep=0pt] (tmp) at (\xRefPosOne,\yRefPosOne)
    {\includegraphics[width=14cm]{IT_barrel_2.png}};
    
    \node[inner sep=0pt] (tmp) at (\xRefPosOne,\yRefPosOne+2.5)
    {\mySmallCenterBox{Theta: 50..130}};
%  
%  \node[inner sep=0pt] (tmp) at (\xRefPosOne + \xRefIncrementOne,\yRefPosOne)
%     {\includegraphics[width=5.0cm]{totalMaterial_WithAndWithoutBeampipe.png}};    
...
\renewcommand{\xRefIncrementOne}{6.0}
 ...
 \node[inner sep=0pt] (tmp) at (\xRefPosOne,\yRefPosOne)
    {\includegraphics[width=14cm]{IT_endcaps_1.png}};
...
\renewcommand{\xRefIncrementOne}{6.0}
 ...
 \node[inner sep=0pt] (tmp) at (\xRefPosOne,\yRefPosOne)
    {\includegraphics[width=14cm]{IT_endcaps_2.png}};
    
    \node[inner sep=0pt] (tmp) at (\xRefPosOne,\yRefPosOne+2.5)
    {\mySmallCenterBox{Theta: 0..40}};
...
\renewcommand{\xRefIncrementOne}{6.0}
 ...
 \node[inner sep=0pt] (tmp) at (\xRefPosOne,\yRefPosOne)
    {\includegraphics[width=14cm]{IT_endcaps_3.png}};

    \node[inner sep=0pt] (tmp) at (\xRefPosOne,\yRefPosOne+2.5)
    {\mySmallCenterBox{Theta: 35..36}};
...
\renewcommand{\xRefIncrementOne}{6.0}
 ...
 \node[inner sep=0pt] (tmp) at (\xRefPosOne,\yRefPosOne)
    {\includegraphics[width=14cm]{OT_barrel_1.png}};
...
\renewcommand{\xRefIncrementOne}{6.0}
 ...
 \node[inner sep=0pt] (tmp) at (\xRefPosOne,\yRefPosOne)
    {\includegraphics[width=14cm]{OT_endcaps_1.png}};
\node[inner sep=0pt] (tmp) at (\xRefPosOne,\yRefPosOne+2.5)
    {\mySmallCenterBox{Theta: 0..180}};  
...
\renewcommand{\xRefIncrementOne}{6.0}
 ...
 \node[inner sep=0pt] (tmp) at (\xRefPosOne,\yRefPosOne)
    {\includegraphics[width=14cm]{OT_endcaps_2.png}};

\node[inner sep=0pt] (tmp) at (\xRefPosOne,\yRefPosOne+2.5)
    {\mySmallCenterBox{Theta: 20..55}};
...
\renewcommand{\xRefIncrementOne}{6.0}
 ...
 \node[inner sep=0pt] (tmp) at (\xRefPosOne,\yRefPosOne)
    {\includegraphics[width=14cm]{OT_endcaps_3.png}};
    
    \node[inner sep=0pt] (tmp) at (\xRefPosOne,\yRefPosOne+2.5)
    {\mySmallCenterBox{Theta: 55..56}};
...
\renewcommand{\xRefIncrementOne}{6.0}
 ...
 \node[inner sep=0pt] (tmp) at (\xRefPosOne,\yRefPosOne)
    {\includegraphics[width=14cm]{full_det_1.png}};
...
\renewcommand{\xRefIncrementOne}{6.0}
 ...
 \node[inner sep=0pt] (tmp) at (\xRefPosOne,\yRefPosOne)
    {\includegraphics[width=14cm]{full_det_2.png}};
    
    \node[inner sep=0pt] (tmp) at (\xRefPosOne,\yRefPosOne+2.5)
    {\mySmallCenterBox{Theta: 60..120}};
...
\renewcommand{\xRefPosOne}{4.6}
\renewcommand{\xRefIncrementOne}{5.5}

 \node[inner sep=0pt] (tmp) at (\xRefPosOne,\yRefPosOne)
    {\includegraphics[width=9cm]{CLIC_nHits.png}};
